...
##train classifier
   ##
class Omics_Class_encoder1(torch.nn.Module):
    def __init__(self,emb_dim=64,emb_gene1=10,omic_genecomponent1=400,omics_tokens1=4000, encoder_head=4,encoder_layer=6) -> None:
        super().__init__()
...
class Omics_Classifier(torch.nn.Module):
    def __init__(self, config) -> None:
        ...
        self.omics2_encoder = Omics_Class_encoder1(config.emb_dim,config.emb_gene1,config.omic_genecomponent1,config.omics_tokens1,config.encoder_head,config.encoder_layer)
    ...
    def forward(self, patches1,patches2):
        ...
        patches2 = self.omics2_encoder(patches2)
